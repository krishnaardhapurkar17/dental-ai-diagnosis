...
MODEL_PATH = r'model1_classification\checkpoints\best_model.pth'
DATA_DIR = r'model1_classification\data\test'
OUTPUT_DIR = r'outputs\model1_classification_outputs'
NUM_SAMPLES = 20
DEVICE = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

CLASS_NAMES = ['BDC-BDR', 'Caries', 'Healthy Teeth', 'Impacted teeth', 'Other Pathology']
